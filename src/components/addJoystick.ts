...
export function addJoystick(
  ...
  const base = k.add([
    'joystickBase',
    hud({shouldBeShown: true, targetOpacity: 0.2}),
    k.pos(-9999, -9999),
    k.circle(size / 2),
    k.color(0, 0, 0),
    k.anchor('center'),
  ...
  const knob = k.add([
    'joystickKnob',
    hud({shouldBeShown: true, targetOpacity: 0.7}),
    k.pos(-9999, -9999),
    k.circle(size / 4),
    k.color(255, 255, 255),
    k.anchor('center'),
  ...
  k.add([
    ...
    k.sprite('joystick.jump'),
    k.pos(jumpButton.pos),
    k.anchor('center'),
  ]);
  ...
  k.add([
    hud({shouldBeShown: true}),
    k.sprite('joystick.attack'),
    k.pos(attackButton.pos),
    k.anchor('center'),
    k.scale(1.2),
  ]);
